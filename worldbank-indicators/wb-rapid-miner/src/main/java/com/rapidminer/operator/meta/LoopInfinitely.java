...
public class LoopInfinitely extends OperatorChain {
	...
	public List<ParameterType> getParameterTypes() {
		...
		types.add(new ParameterTypeBoolean(PARAMETER_RESTRICT_FREQUENCY, "If checked, the frequency of subprocess execution might be restricted.", false, false));
		
		ParameterType type = new ParameterTypeInt(PARAMETER_FREQUENCY, "This parameter defines the number of seconds between the start of two subsequent subprocess executions.", 1, Integer.MAX_VALUE, 5, false);
