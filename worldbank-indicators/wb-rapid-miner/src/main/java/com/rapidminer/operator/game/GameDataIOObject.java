...
/**
 * This class contains the game date, recorded during 
 * runtime of the game. 
 * 
...
public class GameDataIOObject extends ResultObjectAdapter {
	...
	/**
	 * This sets a value of this GameDataIOObject, which is later on extracted
	 * as an attribute in the resulting ExampleSet.
	 */
