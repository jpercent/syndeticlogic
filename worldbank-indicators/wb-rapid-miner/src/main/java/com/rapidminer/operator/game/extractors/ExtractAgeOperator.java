...
public class ExtractAgeOperator extends Operator {
	...
	public void doWork() throws OperatorException {
		GameDataIOObject input = gameDataInput.getData();
	...
	/**
	 * This method could extract arbitrary properties from the GameData and put it as a key value pair into 
	 * the GameDataIOObject. Each pair will become a single attribute in the resulting ExampleSet and hence
	 * each execution of the subprocess must result in exactly the same number of pairs.
	 * Otherwise for some examples there are undefined attributes.
	 */
